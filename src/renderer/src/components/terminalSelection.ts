 ...
 *
 * Claude Code paints its decoration INTO the character grid: a markdown
 * blockquote is drawn as `▎ text`, so the rail is a real cell on that line,
 * not a border beside it. Selecting the line (a triple-click, a full-width
 * drag) therefore copies the rail with the prose, and the paste lands as:
 *
